...
const INITIAL_DATASETS: Dataset[] = [
  {
    ...
    description:
      "Comprehensive climate measurements from 10,000+ weather stations worldwide, updated daily with temperature, humidity, and precipitation data.",
    provider: "ClimateDAO",
  ...
  },
  {
    ...
    description:
      "Real-time and historical financial data covering stocks, bonds, commodities, and crypto markets with millisecond precision.",
    ...
    coverage: "Global",
    domain: "Finance",
    files: [{ name: "market_data.csv", size: 6000000000, type: "csv" }],
  },
  {
    id: "3",
    title: "Medical Imaging Collection",
    description:
      "Anonymized medical scans including X-rays, MRIs, and CT scans with expert annotations for machine learning research.",
    ...
    domain: "Healthcare",
    files: [{ name: "xray_images.zip", size: 13000000000, type: "zip" }],
  },
];
